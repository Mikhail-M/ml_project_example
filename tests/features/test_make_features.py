...
def test_make_features(
    ...
    features = make_features(fitted_transformer, dataset, feature_params)
...
def test_split_train_features(
    ...
    train_features = make_features(fitted_transformer, train_df, feature_params)
    val_features = make_features(fitted_transformer, val_df, feature_params)
